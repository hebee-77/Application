...
<main class="wrap">
  ...
  <section class="restaurant-banner" style="background-image:url('https://images.unsplash.com/photo-1550317138-10000687a72b?auto=format&fit=crop&w=1200&q=70');">
  </section>
...
<div class="cart-bar">
  <a href="${pageContext.request.contextPath}/cart" class="cart-bar-link">
    View cart
    <svg viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" stroke-width="2.5"><path d="M5 12h14M13 6l6 6-6 6"/></svg>
  </a>
</div>
